...
function wds_aquarium_dr7_regions() {
  return array(
 ...
 * @ingroup themeable
 */
function wds_aquarium_dr7_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function wds_aquarium_dr7_feed_icon($url) {
 ...
 */
function wds_aquarium_dr7_comment_wrapper($content, $type = null) {
  static $node_type;
 ...
 */
function wds_aquarium_dr7_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function wds_aquarium_dr7_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function wds_aquarium_dr7_button($element) {
...
*/
function wds_aquarium_dr7_img_assist_page($content, $attributes = NULL) {
